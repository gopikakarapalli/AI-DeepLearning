...
Datadb ="E:/Learning/Programming/AI/Datadb/classification_images"
DataPath = Datadb #os.path.join( PATH,'data')
...
pickle.dump(data,open('../Temp/imagedata_set.pickle','wb'))
print('data set file saved')
